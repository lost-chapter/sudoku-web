...
**メモモードのキーは残してあり、キーボードだけで遊べることも変わらない。**
...
| **それ以外の押せるもの** | **44px 四方以上。例外を作らない。** 入力パッド・ホーム画面のボタン・ヘッダのボタンを含む。**大きさを自由に取れるものに、下げる理由が無い**(実測は 375px 幅で入力パッドが 68 × 48px、ホームの難易度が 94 × 44px) |
