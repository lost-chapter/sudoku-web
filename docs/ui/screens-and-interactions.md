...
|------|------|
| セルをタップ | そのセルを選択する |
| セルから 24px 以上スワイプ | 開始セルを中心に `1 2 3 / 4 5 6 / 7 8 9` の方向ガイドと、指の近くに **現在の数字を大きく表示するガイド**を出す |
| スワイプ中に方向を変える | 方向ガイドの対応数字を青く強調し、iPhone キーボードのガイドのように指の近くの数字表示も切り替える |
| 指を離す | ガイドに表示中の数字を選択中のセルへ入力する。メモモード中はメモとして扱う |
| 手がかりのセル / 完成後の盤面 | スワイプ入力を受け付けない |

**長押しではなく短いスワイプで判定する。** 文字選択・コンテキストメニュー・画面スクロールと
