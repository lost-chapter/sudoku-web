...
| 3 | 生成の性能(1 問あたりの所要時間) | ⚠️ **桁は分かったが値が確定していない。**1 問 **1.56〜15 ms**(測る環境で 10 倍ぶれる。[検証の追記](../reports/2026-08-05-puzzle-generation-benchmark.md))。**生成が律速にならない**ことは確か。難易度評価そのものは 0.14 ms/問と安い |
