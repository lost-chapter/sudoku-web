...
| 型チェック / Lint / 整形 | 0 エラー |
| 本番ビルド | JS 344.92 KB(gzip **106.60 KB**)/ CSS 233.55 KB(gzip 34.31 KB) |
...
**次の一手は工程 2 の 7(レベル 5〜7 の手筋・agent-b)と工程 4 の残り(agent-c)。**
...
| 7 | **レベル 5〜7 の手筋**(X-Wing / XY-Wing / チェーン系) | **次はここ**(2026-08-05 に追加)。下記「難易度クラスの供給」 |
...
| # | 課題 | いつ分かるか |
|---|------|------------|
| 1 | 同梱パックを難易度ごとに何問にするか | ⏳ **判断材料は揃った。**暫定どおり **1 クラス 1,000 問**で収録済み。1 パック **172 KB(gzip 67 KB)**、生成は 8 並列で 0.7〜3.5 秒([検証](../reports/2026-08-05-puzzle-generation-benchmark.md))。**減らすなら 200 問 = 34 KB も選べる** |
