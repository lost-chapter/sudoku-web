...
> **工程 11(スマホのスワイプ入力)まで 0.4.0 として公開した。工程 10(画面デザイン)は発注者の確認待ちで継続している。**
...
- 進行中の作業: [実装の進め方と現在地](guides/implementation-roadmap.md) — **工程 10(UI の作り込み)の確認待ち**。担当の割り当ては [作業の引き継ぎ](guides/handover.md#3-いまの体制) の体制表にある
